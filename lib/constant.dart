const kIndexFileUrl = 'assets/index.json';
const kContentBaseUrl = 'assets/content';
const contentExtension = 'png';
const kCharactersDirName = 'characters';
const kTutorialsDirName = 'tutorials';
const kStepsDirName = 'steps';
